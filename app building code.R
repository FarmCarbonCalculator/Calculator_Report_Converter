...
ui <- fluidPage(tags$head(tags$link(href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;600&display=swap",rel="stylesheet"),tags$style(HTML("body {font-family: 'Poppins',sans-serif !important;}"))),
  tags$div(class="app-header",tags$img(src="logo.png",class="app-logo"),
           tags$div(class="app-title",tags$h1("Calculator Report Converter"), tags$h4("Convert reports between Main, Equine, and Isle of Man calculators"))),
